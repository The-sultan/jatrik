...
@Entity
@Table(name = "REL_PARTIDOS_EVENTOS_TARJETA_ROJA")
@DiscriminatorValue(value = "3")
@PrimaryKeyJoinColumn(name = "ID")
public class RelPartidoEventoTarjetaRoja extends RelPartidoEvento {
	...
	public RelPartidoEventoTarjetaRoja(Integer minuto, Partido partido, Evento evento, Jugador jugador, Equipo equipo) {
	...
	public RelPartidoEventoTarjetaRoja(){
		super();
	}
