	...
	public Long crearUsuario(InfoUsuario infoUsuario) {
		try {
			...
			if (usuarios.findUsuarioByNick(infoUsuario.getNick()) == null) {
				...
				equipo.setLatitud(infoUsuario.getInfoEquipo().getEstadio().getLatitud());
				equipo.setLongitud(infoUsuario.getInfoEquipo().getEstadio().getLongitud());
				equipo.setAltura(infoUsuario.getInfoEquipo().getEstadio().getAltura());
