...
public interface RestClientEJBLocal {
	...
	public Boolean getPuedeEntrenarEquipo(long idEquipo)
			throws RestClientException;
	...
	InfoFormacion getFormacionEstandar(Long equipoId)
			throws RestClientException;

	InfoFormacion getFormacionProximoPartido(Long equipoId)
			throws RestClientException;

	void storeFormacionEstandar(Long equipoId, InfoFormacion infoFormacion)
			throws RestClientException;

	void storeFormacionProximoPartido(Long equipoId, InfoFormacion infoFormacion)
			throws RestClientException;
	...
	String postTransferenciaVenta(
			InfoTransferenciaVenta paramInfoTransferenciaVenta)
			throws RestClientException;

	String postTransferenciaCompra(
			InfoTransferenciaCompra paramInfoTransferenciaCompra)
			throws RestClientException;
	...
	InfoLiga getInformacionLiga(Long idLiga);
